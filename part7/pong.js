...
Pong = {
  ...
  stop: function(ask) {
    if (this.playing) {
      if (!ask || this.runner.confirm('Do you really wanted to quit this game???')) {
        this.playing = false;
  ...
  goal: function(playerNo) {
    ...
    if (this.scores[playerNo] == 9) {
      ...
      audio = new Audio("sounds/goal.wav");
      audio.play();
    }
  },
  ...
  Menu: {
    ...
    initialize: function(pong) {
      ...
      this.winner1 = { image: winner, x: (pong.width/2) - winner.width - pong.cfg.wallWidth, y: 16 * pong.cfg.wallWidth };
      this.winner2 = { image: winner, x: (pong.width/2)                + pong.cfg.wallWidth, y: 16 * pong.cfg.wallWidth };
    },
